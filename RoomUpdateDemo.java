...
class RoomUpdate implements ActionListener
{
	JFrame f;
	JTable tab;
	JScrollPane jsp;
	...
	public RoomUpdate()
	{
		...
		l1.setBounds(350,20,250,35);
		f.add(l1);
		
		t1=new JTextField(10);
		t1.setFont(f3);
		t1.setBounds(550,20,150,35);
		f.add(t1);
		
		b1=new JButton("Submit");
		b1.setBounds(700,20,150,35);
		b1.setFont(f2);
		f.add(b1);
		
		b=new JButton("Update");
		b.setBounds(400,500,200,40);
		b.setFont(f2);
		f.add(b);
		
		b2=new JButton("Back");
		b2.setBounds(650,500,200,40);
		b2.setFont(f2);
		f.add(b2);
