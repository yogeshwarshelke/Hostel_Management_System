...
class ClassSearch implements ActionListener
{
	...
	ClassSearch()
	{
		...
		l1=new JLabel("Student Class:");
		l1.setFont(f2);
		l1.setForeground(Color.ORANGE);
		l1.setBounds(300,20,300,35);
		f.add(l1);
		
		t1=new JTextField(10);
		t1.setFont(f3);
		t1.setBounds(570,20,150,35);
		f.add(t1);
		
		b1=new JButton("Search");
		b1.setBounds(720,20,150,35);
		b1.setFont(f2);
		f.add(b1);
		
		b2=new JButton("Back");
		b2.setBounds(500,500,150,40);
		b2.setFont(f2);
		f.add(b2);
		
		l2=new JLabel("Invalid class...");
		l2.setFont(f2);
	...
	{  
	   if(e.getSource()==b1)
	   {
		...
		try
		{
			...
			String sql="select * from StudentAddmission where NewClass=?";
