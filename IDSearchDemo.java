...
class IDSearch implements ActionListener
{
	JFrame f;
		...
		if(e.getSource()==b)
		{
			...
			try
			{
				...
				while(rs.next())
				{
					...
					//bg.setText(rs.getString(12));
					if(rs.getString(12).equals("Male"))
					{
						rb1.setSelected(true);
					}
					//if(rs.getString(12).equals("Female"))
					else
					{
					...
					/*cb1.setText(rs.getString(17));
					cb2.setText(rs.getString(18));
					cb3.setText(rs.getString(19));
					cb4.setText(rs.getString(20));
					*/
					flag=1;
