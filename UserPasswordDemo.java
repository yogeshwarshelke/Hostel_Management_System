...
class UserPassword implements ActionListener
{
	JFrame f;
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==b1)
		{
			...
			if(user.equals("yogesh shelke")&&pass.equals("yogesh"))
			{
		...
		if(e.getSource()==b2)
		{
			...
			{
				JOptionPane.showMessageDialog(null,"Thank you for User System","Exit",JOptionPane.ERROR_MESSAGE);
				System.exit(0);
			}
		}
	}
